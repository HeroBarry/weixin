...
import com.dmd.weixin.qy.message.QyXmlMessages;
 ...
 */
@Controller
@Api(value = "企业号回调控制器", description = "企业号回调控制器")
...
/*    @Value("${agent.default.token}")
    ...
    @GetMapping("/wx/qy")
    @ResponseBody
    @ApiOperation(value = "企业号回调接口",notes = "企业号回调接口")

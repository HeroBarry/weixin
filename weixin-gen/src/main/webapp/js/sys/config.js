...
function createOnePage(){
    ...
    LODOP.SET_PRINT_PAGESIZE(0,3,0,400,400,"普通内容");
    //LODOP.ADD_PRINT_TEXT(10,10,200,30,"");
    //LODOP.ADD_PRINT_HTM(30,10,200,30,"<hr>JSON.stringify(ids)<hr>");
};